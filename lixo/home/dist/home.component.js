...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(globalService, eventoComplementarSrv, eventoSrv, breakpoint, router, decimalPipe, firstNamePipe, route, appSnackBar, formBuilder) {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.globalService.logado$.subscribe(function (show) {
            _this.isLogado = show;
            console.log("Logado!", show, _this.globalService.getUsuario());
            /*  if (show) {
               this.getEventos();
             } */
        });
