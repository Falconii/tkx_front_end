...
export class EntregaService {
  ...
  getEntregasParametro_01(
    params: ParametroEntrega01,
  ): Observable<EntregaModel[]> {
  ...
  getEntrega(
    ...
    return this.http.get<EntregaModel>(
      `${this.apiURL}entrega/${id_empresa}/${id_evento}/${id_inscrito}`,
    );
  }
